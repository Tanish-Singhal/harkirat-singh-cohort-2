...
export const FullBlog = ({ blog } : {blog: Blog}) => {
  return (
    <div>
      ...
      <div className="w-full px-10 grid grid-cols-12 pt-10 pb-5">
        <div className="grid col-span-8 p-5">
          ...
          <p className="text-slate-500 mt-10">{blog.content}</p>
        </div>
        
        <div className="grid col-span-4 p-5 pt-7">
          <div>
            ...
            <div className="flex justify-center items-center gap-2">
              ...
              <div>
                <h2 className="text-xl font-bold mt-4">{blog.author.name || "Anonymous"}</h2>
